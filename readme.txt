Folder Routers จะเป็นการรับข้อมูล req.res จาก folder controller เพื่อส่งไปให้ File server
Folder controller ถูกสร้างเพื่อส่ง req.res ของแต่ละไฟล์ไปให้ Folder Router
...
//หลักจาก exports import prisma แล้วติดตั้งใน command
